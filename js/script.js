...
$( document ).ready(function() {
    ...
    $('.ym_header_phone').click(function(){
        ym(90275381,'reachGoal','header_phone')
	});

    $('.ym_footer_phone').click(function(){
        ym(90275381,'reachGoal','footer_header')
	});

    $('.ym_header_btn').click(function(){
        ym(90275381,'reachGoal','ym_header_btn')
	});

    $('.ym_lead_btn').click(function(){
        ym(90275381,'reachGoal','ym_lead_btn')
	});

    $('.ym_buy_btn').click(function(){
        ym(90275381,'reachGoal','ym_buy_btn')
	});

    $('.ym_footer_btn').click(function(){
        ym(90275381,'reachGoal','footer_btn')
	});

    $('.ym_modal_btn').click(function(){
        ym(90275381,'reachGoal','modal_btn')
	});
